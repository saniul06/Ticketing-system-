    ...
    return (
        <div>
            ...
            <div className={addClass ? "p-0 pt-3 mobile-sidebar responsive left" : "p-0 pt-3 mobile-sidebar responsive"}>
                ...
                <ul className=' '>
                    <li className={dashboard ? 'sidebar-active' : ''} > <Link to='/'>Dashboard</Link></li >
                    <li className={employeesList ? 'sidebar-active' : ''}><Link to='/employees-list'>Employees List</Link></li>
                    <li className={ticketsList ? 'sidebar-active' : ''}><Link to='/tickets-list'>Tickets List</Link></li>
                    <li className={createTicket ? 'sidebar-active' : ''}><Link to='/create-ticket'>Create Ticket</Link></li>
                </ul>
            </div>
